...
function initSectionAnimations() {
    ...
    // EmailJS is initialized in index.html before this script loads
    ...
    if (form) {
      form.addEventListener('submit', function (e) {
        ...
        emailjs.sendForm(
            "service_k2bmpnc",   // Your EmailJS Service ID
            "template_l0cv836",  // Your EmailJS Template ID
            this,
  "8u0yw3-40LkZDuh_g" // Your EmailJS Public Key
        ).then(
            () => {
